      ...
      <div className="container hero-inner">
        ...
        <form id="search-form" className="search-form" onSubmit={handleSearch}>
          ...
          <p id="search-hint" className="search-hint">
            הזינו מספר רישוי בן 7 או 8 ספרות
            <span> · </span>
            המידע בהתאם לזמינות במאגרי משרד התחבורה
          </p>
  ...
  return (
    ...
    >
      ...
      <div className="faq-list">
        <details>
          <summary>
            איזה מידע מוצג בדוח הרכב?
            <svg className="icon" aria-hidden="true">
              <use href="#i-plus" />
            </svg>
          </summary>
          <p>
            הדוח מציג פרטי רכב, נתוני רישוי, מפרט טכני והיסטוריית
            בעלויות, בהתאם למידע הזמין במאגרי משרד התחבורה עבור
            מספר הרישוי שהוזן.
          </p>
        </details>
        ...
        <details id="mileage-faq">
          ...
          <p>
            הקילומטראז׳ המוצג הוא הקריאה מהטסט האחרון שדווחה
            במאגר. הוא אינו מדידה בזמן אמת, וייתכן שהרכב נסע
            קילומטרים נוספים מאז.
          </p>
        </details>

        <details>
          <summary>
            למה חלק מהפרטים מסומנים כ״לא נמסר״?
            <svg className="icon" aria-hidden="true">
              <use href="#i-plus" />
            </svg>
          </summary>
          <p>
            הסימון מופיע כאשר לא התקבל נתון מתאים מהמאגר.
            היעדר מידע אינו מעיד שהערך הוא אפס או שלא היו
            אירועים בהיסטוריית הרכב.
          </p>
        </details>
      </div>
    </section>
